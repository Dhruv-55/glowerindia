            ...
            <div class="mega-menu shop-menu">
              <div class="row"> 
                    ...
                    <div class="col-md-12">
                      <div class="month-deal">
                        <div>
                          ...
                          <p class="mb-0">Yes! Send me exclusive offers, personalised, and unique gift ideas, tips for shopping on Glower <a href="shop-standard.html" class="dz-link-2">View All Products</a></p>
                        </div>
                ...
                <div class="col-md-4 d-none d-lg-block">
                  <div class="adv-media"><img src="/website-assets/images/adv-1.png" alt="/"></div>
                </div>
              </div>
            </div>
          </li>
            ...
            <div class="mega-menu">
              <div class="row">
                <div class="col-9">
                  <div class="row">
                  <div class="col-md-4 col-sm-4 col-6">
                    <a href="javascript:;" class="menu-title">Blog Style</a>
                    <ul>
                      <li><a href="blog-post-style-1.html">Blog Post Style 1</a></li>
                      <li><a href="blog-post-style-2.html">Blog Post Style 2</a></li>
                      <li><a href="blog-post-style-3.html">Blog Post Style 3</a></li>
                    </ul>
                    <a href="javascript:;" class="menu-title">Blog Sidebar</a>
                    <ul>
                  ...
                  <div class="widget widget_post pt-2">
                    <ul>
                      <li>
                        <div class="dz-media">
                          <img src="/website-assets/images/shop/product/small/1.png" alt="">
                        </div>
                        <div class="dz-content">
                          <h6 class="name"><a href="post-standard.html">Hydrated Supple Skin</a></h6>
                          <span class="time">July 23, 2023</span>
                        </div>
                      </li>
                      <li>
                        <div class="dz-media">
                          <img src="/website-assets/images/shop/product/small/2.png" alt="">
                        </div>
                        <div class="dz-content">
                          <h6 class="name"><a href="post-standard.html">Glowing Radiant Skin</a></h6>
                          <span class="time">July 23, 2023</span>
                        </div>
                      </li>
                      <li>
                        <div class="dz-media">
                          <img src="/website-assets/images/shop/product/small/3.png" alt="">
                        </div>
                        <div class="dz-content">
                          <h6 class="name"><a href="post-standard.html">Silky Soft Skin</a></h6>
                          <span class="time">July 23, 2023</span>
                        </div>
                      </li>
                    </ul>
                ...
                <div class="col-md-3 d-none d-lg-block">
                  <div class="adv-media"><img src="/website-assets/images/adv-4.png" alt="/"></div>
                </div>
              </div>
              ...
              <div class="row"> 
                <div class="col-xl-10 col-lg-9 col-md-9 pe-xl-5 pe-md-3 col-sm-8 "> 
                  <ul class="row portfolio-nav-link">
                    <li class="col"><a href="portfolio-tiles.html"><img src="/website-assets/images/portfolio/icons/portfolio-tiles.svg" alt="/"><span>Portfolio Tiles</span></a></li>
                    <li class="col"><a href="collage-style-1.html"><img src="/website-assets/images/portfolio/icons/collage-style-1.svg" alt="/"><span>Collage Style 1</span></a></li>
                    <li class="col"><a href="collage-style-2.html"><img src="/website-assets/images/portfolio/icons/collage-style-2.svg" alt="/"><span>Collage Style 2</span></a></li>
                    <li class="col"><a href="masonry-grid.html"><img src="/website-assets/images/portfolio/icons/masonry-grid.svg" alt="/"><span>Masonry Grid</span></a></li>
                    <li class="col"><a href="cobble-style-1.html"><img src="/website-assets/images/portfolio/icons/cobble-style-1.svg" alt="/"><span>Cobble Style 1</span></a></li>
                    <li class="col"><a href="cobble-style-2.html"><img src="/website-assets/images/portfolio/icons/cobble-style-2.svg" alt="/"><span>Cobble Style 2</span></a></li>
                    <li class="col"><a href="portfolio-thumbs-slider.html"><img src="/website-assets/images/portfolio/icons/portfolio-thumbs-slider.svg" alt="/"><span>Portfolio Thumbs Slider</span></a></li>
                    <li class="col"><a href="portfolio-film-strip.html"><img src="/website-assets/images/portfolio/icons/portfolio-film-strip.svg" alt="/"><span>Portfolio Film Strip</span></a></li>
                    <li class="col"><a href="carousel-showcase.html"><img src="/website-assets/images/portfolio/icons/carousel-showcase.svg" alt="/"><span>Carousel Showcase</span></a></li>
                    <li class="col"><a href="portfolio-split-slider.html">	<img src="/website-assets/images/portfolio/icons/portfolio-split-slider.svg" alt="/"><span>Portfolio Split Slider</span></a></li>
                  </ul>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-3 line-left ps-3 pe-0 col-sm-4"> 
                  <a href="javascript:;" class="menu-title">Portfolio Details</a>
                  <ul>
...
<div class="mega-menu">
  <div class="row justify-content-md-between"> 
    <div class="col-md-2 col-sm-4 col-6"> 
      <a href="javascript:;" class="menu-title">Pages</a>
      <ul>
    ...
    <div class="col-md-2 col-sm-4 col-6"> 
      <a href="javascript:;" class="menu-title">Contact Us</a>
      <ul>
      ...
      <a href="javascript:;" class="menu-title">Web Pages</a>
      <ul>
    ...
    <div class="col-md-2 col-sm-4 col-6"> 
      <a href="javascript:;" class="menu-title">Banner Style</a>
      <ul>						
    ...
    <div class="col-md-2 col-sm-4 col-6">
      <a href="javascript:;" class="menu-title">Header Style</a>
      <ul>
    ...
    <div class="col-md-2 col-sm-4 col-6">
      <a href="javascript:;" class="menu-title">Footer Style</a>
      <ul>
...
<li class="sub-menu-down"><a href="javascript:void(0);">My Account <i class="fas fa-chevron-down tabindex"></i></a>
<ul class="sub-menu">						
