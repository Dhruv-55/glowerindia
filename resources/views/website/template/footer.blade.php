                  ...
                  <div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="widget widget_about me-2">
                      ...
                      <div class="subscribe_widget">
                        ...
                        <form class="dzSubscribe style-1" action="https://glower.indiankoder.com/xhtml/script/mailchamp.php" method="post">
                      ...
                      <ul>
                        <li>
                          ...
                          <div class="dz-content">
                            <h6 class="name"><a href="javascript:void(0);">Hydrated Supple Skin</a></h6>
                        ...
                        <li>
                          ...
                          <div class="dz-content">
                            <h6 class="name"><a href="javascript:void(0);">Glowing Radiant Skin</a></h6>
                            <span class="time">July 23, 2023</span>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="dz-content">
                            <h6 class="name"><a href="javascript:void(0);">Silky Soft Skin</a></h6>
                            <span class="time">July 23, 2023</span>
                          </div>
                        </li>
                      </ul>
              ...
              <div class="container">
                <div class="row fb-inner wow fadeInUp" data-wow-delay="0.1s">
                  <div class="col-lg-6 col-md-12 text-start"> 
                    <p class="copyright-text">© <span class="current-year">{{ now()->format('Y') }}</span> <a href="javascript:void(0)">{{ env('APP_NAME')  }}</a> Theme. All Rights Reserved.</p>
                  </div>
                  <div class="col-lg-6 col-md-12 text-end"> 
                    <div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-xl-end">
                      ...
                      <img src="/website-assets/images/footer-img.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row gx-0">
											...
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<div class="dz-media DZoomImage">
														<img src="images/products/product-item-1.png" alt="image">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-xl-6 col-md-6">
								<div class="dz-product-detail style-2 mb-0">
									<div class="dz-content">
										<div class="dz-content-footer">
											<div class="dz-content-start">
												<span class="badge mb-2">SALE 20% Off</span>
												<h4 class="title mb-1"><a href="shop-list.html">Crystal Clear Cleanser</a></h4>
										...
										<p class="para-text">
											Lorem Ipsum is simply dummy text of the printing & typesetting industry.  Ipsum has been the industry's standarddummy text
										</p>
										<div class="meta-content m-b20 d-flex align-items-end">
											<div class="me-3">
												<span class="form-label">Price</span>
												<span class="price">$45.00 <del>$72.17</del></span>
											</div>
											<div class="btn-quantity light me-0 ms-4">
										...
										<div class="dz-info mb-0">
											...
											<ul>
												...
												<li><a href="shop-standard.html">Beauty Tools, </a></li>												
												<li><a href="shop-standard.html">Gift Sets,</a></li>												
											</ul>
											<ul>
