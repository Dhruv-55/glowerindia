    ...
    public function create(Request $request){
        ...
        if($request->isMethod('post')){
          ...
          DB::transaction(function() use($request) {
            ...
            return redirect()->route('admin-category-view')->with(['error' => 'Category Created Successfully']);
        }
    ...
    public function update(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            $category_image = null;
                ...
                return redirect()->route('admin-category-view')->with(['error' => 'Category Updated Successfully']);
