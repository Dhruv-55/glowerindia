  ...
  public function create(Request $request){
    ...
    if($request->isMethod('post')){
      ...
      DB::transaction(function() use($request) {
        ...
        return redirect()->route('admin-brand-view')->with(['error' => 'Brand Created Successfully']);
    }
  ...
  public function update(Request $request){
    ...
    if($request->isMethod('post')){
        ...
        $brand_image = null;
            ...
            return redirect()->route('admin-brand-view')->with(['error' => 'Brand Updated Successfully']);
